	...
	public class RadarService {
	    ...
	    // ============================================================
	    public Map<String, Double> calcularProgresso(Long criancaId) {
	    ...
	    public Map<String, Object> calcularProgressoDashboard(Long criancaId) {

	        Map<String, Double> progressoPorArea = calcularProgresso(criancaId);
	        List<Map<String, Object>> lista = new ArrayList<>();

	        progressoPorArea.forEach((area, valor) -> {
	            Map<String, Object> item = new HashMap<>();
	            item.put("area", area);
	            item.put("percentual", valor.intValue());
	            lista.add(item);
	        });

	        Map<String, Object> resposta = new HashMap<>();
	        resposta.put("progresso", lista);
