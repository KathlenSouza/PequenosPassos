...
public class RadarController {
    ...
    public ResponseEntity<Map<String, Double>> progresso(@PathVariable Long id) {
        return ResponseEntity.ok(radarService.calcularProgresso(id));
    }

    @GetMapping("/dashboard/{id}")
    public ResponseEntity<Map<String, Object>> progressoDashboard(@PathVariable Long id) {
        Map<String, Object> progresso = radarService.calcularProgressoDashboard(id);
